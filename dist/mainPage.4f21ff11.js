...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/components/productCard.js":[function(require,module,exports) {
"use strict";
...
var _productCard = require("../components/productCard.js");
var _mainTitle = require("../components/mainTitle.js");
function getMainPage() {
  var page = document.createElement('div');
  page.classList.add('page', 'main-page', 'container');
  var mainTitle = (0, _mainTitle.getMainTitle)('The main page');
  var list = document.createElement('ul');
  list.classList.add('product-list', 'list-reset');
  list.append((0, _productCard.getProductCard)('First card', 100), (0, _productCard.getProductCard)('Second card', 200), (0, _productCard.getProductCard)('Third card', 300));
